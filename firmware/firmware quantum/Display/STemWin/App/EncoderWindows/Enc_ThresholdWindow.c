...
//////////////////////////////////////////////////////////////////
  case WM_PAINT:
      ...
      GUI_DispStringAt("threshold [db]", 0, 0);
      GUI_SetFont(&GUI_FontD36x48);
      GUI_GotoXY(0,35);
      GUI_DispFloatMin((-1)*value/10, 1);
  ...
  case WM_NOTIFY_PARENT:
    ...
    case ID_ENC_Button:
      ...
      case WM_NOTIFICATION_CLICKED:
    	  ...
    	  Enc_ThresholdSelected = !Enc_ThresholdSelected;

    	  if(Enc_ThresholdSelected){
    ...
    case WM_USER:
    	//#########UPDATE Color & value#############//
    		...
    		//#########Remote unselect#################//
    			...
    			Enc_ThresholdSelected = !Enc_ThresholdSelected;
    			BUTTON_SetState(hButton, Enc_ThresholdSelected);
    		}
    		//#########################################//
    break;
/////////////////////////////////////////////////////////////////
...
WM_HWIN CreateEnc_ThresholdWindow(void) {

  Enc_ThresholdWindow = WM_CreateWindow(600, 130, 180, 100, WM_CF_HIDE, _cbDialog, 0);

  WM_MULTIBUF_Enable(1);

  return Enc_ThresholdWindow;
}
