...
EncValue2 = EncValue/2;
      ...
      if (sollPos != istPos)
         {
            ...
            OutP =  (sollPos - istPos) * KP;
            OutI =  ((sollPos - istPos) * KI)+ Ilast;
            ...
            OutI =  ((sollPos - istPos) * KI)+ Ilast;
                  ...
                  analogWrite(11,255-0); //links
                  analogWrite(10,(OutP+OutI)); //rechts  
            ...
            OutP =  (istPos - sollPos) * KP;
            OutI =  ((istPos - sollPos) * KI)+ Ilast;
                  analogWrite(11,255-(OutP+OutI)); //links
                  analogWrite(10,0); //rechts  
  ...
  case 3:
    {
    if (k <  5000) {waiting = false; k = k+1;}
    if (k >= 5000) {waiting = true;}
    }
  break; 
