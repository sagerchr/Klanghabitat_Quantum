...
/******************************Wenn Header IST-WERT ist *********************************/
   if (StrINHeader == ist) //auslesen der IST-Wert für POTnumber
     ...
     if (firstbyteIST == 9) {IST_WERT = secondbyteIST +190;} //firstbyte = 9
        ...
        if (number == 0) {if (cc_wert_pot0 != IST_WERT) {MIDI.sendControlChange(number,IST_WERT,midichannel);} cc_wert_pot0 = IST_WERT;}
        if (number == 1) {if (cc_wert_pot1 != IST_WERT) {MIDI.sendControlChange(number,IST_WERT,midichannel);} cc_wert_pot1 = IST_WERT;}
        if (number == 2) {if (cc_wert_pot2 != IST_WERT) {MIDI.sendControlChange(number,IST_WERT,midichannel);} cc_wert_pot2 = IST_WERT;}            
        if (number == 3) {if (cc_wert_pot3 != IST_WERT) {MIDI.sendControlChange(number,IST_WERT,midichannel);} cc_wert_pot3 = IST_WERT;}
        if (number == 4) {if (cc_wert_pot4 != IST_WERT) {MIDI.sendControlChange(number,IST_WERT,midichannel);} cc_wert_pot4 = IST_WERT;}                 
        if (number == 5) {if (cc_wert_pot5 != IST_WERT) {MIDI.sendControlChange(number,IST_WERT,midichannel);} cc_wert_pot5 = IST_WERT;}
        if (number == 6) {if (cc_wert_pot6 != IST_WERT) {MIDI.sendControlChange(number,IST_WERT,midichannel);} cc_wert_pot6 = IST_WERT;}
        if (number == 7) {if (cc_wert_pot7 != IST_WERT) {MIDI.sendControlChange(number,IST_WERT,midichannel);} cc_wert_pot7 = IST_WERT;}
        if (number == 8) {if (cc_wert_pot8 != IST_WERT) {MIDI.sendControlChange(number,IST_WERT,midichannel);} cc_wert_pot8 = IST_WERT;}
        if (number == 9) {if (cc_wert_pot9 != IST_WERT) {MIDI.sendControlChange(number,IST_WERT,midichannel);} cc_wert_pot9 = IST_WERT;}                                    
            
       Serial2.write(firstbyteSOLL); //An Debugger senden...
       StrINHeader = "NULL"; //StrINHeader mit "NULL" beschreiben damit unbekannt
     } 
}
