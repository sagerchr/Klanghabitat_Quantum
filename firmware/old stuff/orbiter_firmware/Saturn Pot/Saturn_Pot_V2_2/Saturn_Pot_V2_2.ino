...
if (l_last != l) {PrintRing (MODE, l);} //Wenn Änderung dann PrintRing
  ...
  if (sub >= 64) {sub=sub-64;}
   ...
   int minus = 32 - t;
           ...
           for (int k = 0; k < 64; k++)
          {
           ...
           if (k < t + 7) {Tlc.set(k,100*swell*2);}
           ...
           if(MODUS == 0)
           {
           if (k == 1) {Tlc.set(k,00*swell*2);}
           if (k == 2) {Tlc.set(k,00*swell*2);}

           if (k == 4) {Tlc.set(k,1000*swell*2);}
           if (k == 5) {Tlc.set(k,1000*swell*2);} 
           
           if (k == 63) {Tlc.set(k,00*swell*2);}
           if (k == 62) {Tlc.set(k,00*swell*2);}
           
           if (k == 60) {Tlc.set(k,00*swell*2);}
           if (k == 59) {Tlc.set(k,00*swell*2);}
           }
           if(MODUS == 1)
           {
           ...
           if (k == 4) {Tlc.set(k,00*swell*2);}
           if (k == 5) {Tlc.set(k,00*swell*2);} 
