...
void setup() {
  LED1.begin();
  LED1.setPixelColor(0, LED1.Color(0,0,0)); LED1.setPixelColor(1, LED1.Color(0,0,0)); LED1.setPixelColor(2, LED1.Color(0,0,0)); LED1.setPixelColor(3, LED1.Color(0,0,0));
  LED1.show();
...
/******************************Serielles Paket für IST-WERT senden************************/
   ...
   EncValue1 = encoder1.read()/4;
     ...
     if (PositionEnc >=31) {PositionEnc = 31;}
  ...
  for (int k = 0; k < 32; k++)
  {
    switch (MODE)
    {
       ...
       case 3://alle LEDs an doller PositionENC an.
      {
        ...
        case 4://alle LEDs an doller PositionENC aus.
      {
        if (k > PositionEnc) 
         {
          Tlc.set(k,2000); 
