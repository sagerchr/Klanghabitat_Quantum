...
void setup() {
  ...
  {
    Tlc.set(k,500); 
    LED1.setPixelColor(0, LED1.Color(0,0,k/2)); LED1.setPixelColor(1, LED1.Color(0,0,k/2)); LED1.setPixelColor(2, LED1.Color(0,0,k/2)); LED1.setPixelColor(3, LED1.Color(0,0,k/2)); LED1.setPixelColor(4, LED1.Color(0,0,k/2));LED1.setPixelColor(5, LED1.Color(0,0,k/2));LED1.setPixelColor(6, LED1.Color(0,0,k/2));LED1.setPixelColor(7, LED1.Color(0,0,k/2));LED1.setPixelColor(8, LED1.Color(0,0,k/2));LED1.setPixelColor(9, LED1.Color(0,0,k/2));
    delay(10);
    Tlc.update();
    LED1.show();
  }
...
/******************************Serielles Paket für IST-WERT senden************************/
 ...
 istPos = PositionEnc * 2;
  ...
  for (int t = 0; t < 10; t++)
  {
  if (t == MODE){LED1.setPixelColor(t, LED1.Color(0,0,10));}
