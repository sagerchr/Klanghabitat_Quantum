...
#define MASK_PDF_controllableResetPin 0x00000200
#define MASK_PDF_lowerBinEdge 0x00000400
#define MASK_PDF_higherBinEdge 0x00000800
#define MASK_PDF_smoothingTime 0x00001000
#define MASK_PDF_alpha 0x00002000
#define MASK_PDF_binSpacing 0x00004000
#define MASK_PDF_reset 0x00008000
#define MASK_PDF_binCenter 0x00010000
#define MASK_PDF_previousOut 0x00020000
#define MASK_PDF_hist 0x00040000
#define OFFSET_PDF_numBins 0x00000008
#define OFFSET_PDF_controllableResetPin 0x00000009
#define OFFSET_PDF_lowerBinEdge 0x0000000A
#define OFFSET_PDF_higherBinEdge 0x0000000B
#define OFFSET_PDF_smoothingTime 0x0000000C
#define OFFSET_PDF_alpha 0x0000000D
#define OFFSET_PDF_binSpacing 0x0000000E
#define OFFSET_PDF_reset 0x0000000F
#define OFFSET_PDF_binCenter 0x00000010
#define OFFSET_PDF_previousOut 0x00000011
#define OFFSET_PDF_hist 0x00000012
