...
/** 
 * @brief Determines the maximum value in a buffer with input stride
 * @param[in] src                   Points to the buffer of data
 * @param[in] srcInc                Increment between source samples
 * @param[in] blockSize             Number of samples to process
 * @param[out] *index               Index of the maximum value returned here
...
/** 
 * @brief Determines the minimum value in a buffer with input stride
 * @param[in] src                   Points to the buffer of data
 * @param[in] srcInc                Increment between source samples
 * @param[in] blockSize             Number of samples to process
 * @param[out] *index               Index of the minimum value returned here
 ...
 * @return                          Sum of the squares
 */
FLOAT32 awe_vecSumSquaredStride(
        const FLOAT32 *  src,
		int                        srcInc,
        int                        blockSize);
...
/**
 * @brief Mean Value for the block of samples with input stride
 * @param[in] src                   Points to the source buffer
 * @param[in] srcInc                Increment between samples in src
 * @param[in] blockSize             Number of samples to process
 */
FLOAT32 awe_vecMeanStride(
        const FLOAT32 *  src,
		int                        srcInc,
        int                        blockSize);

/* @brief Root Mean Square  Value for the block of samples
 * @param[in] src                   Points to the source buffer
 * @param[in] blockSize             Number of samples to process
 */
FLOAT32 awe_vecRMS(
...
/* @brief Root Mean Square  Value for the block of samples with input stride
 * @param[in] src                   Points to the source buffer
 * @param[in] srcInc                Increment between samples in src
 * @param[in] blockSize             Number of samples to process
 */
FLOAT32 awe_vecRMSStride(
        const FLOAT32 *  src,
		int                        srcInc,
        int                        blockSize);
 ...
 * @param[in] blockSize             Number of samples to process
 */
FLOAT32 awe_vecAvgEnergyStride(
        const FLOAT32 *  src,
		int                        srcInc,
        int                        blockSize); 
