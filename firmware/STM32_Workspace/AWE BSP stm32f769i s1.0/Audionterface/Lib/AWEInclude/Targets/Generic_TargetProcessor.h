...
#if defined(DSPC_CORTEX_M) || defined(DSPC_CORTEX_R) || defined(CHIP_WM0010)  || defined(XTENSA)
...
static VEC_INLINE UINT32 awe_fwGetCycles(void)
{
	...
	return (cycles);
			...
			int64_t usec = (tv.tv_sec * 1000000) + (tv.tv_nsec / 1000);
