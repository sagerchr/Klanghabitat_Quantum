...
extern DFSDM_Filter_HandleTypeDef hAudioInBottomLeftFilter;
extern DFSDM_Filter_HandleTypeDef hAudioInBottomRightFilter;
...
{
    HAL_DMA_IRQHandler(hAudioInBottomLeftFilter.hdmaReg);
}
...
{
    HAL_DMA_IRQHandler(hAudioInBottomRightFilter.hdmaReg);
}
