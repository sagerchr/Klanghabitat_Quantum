...
#define USBD_PID                      770//769
#define USBD_LANGID_STRING            0x410//0x409
#define USBD_MANUFACTURER_STRING      "STMicroelectronics"
#define USBD_PRODUCT_HS_STRING        "STM32F769I AUDIO Streaming"
#define USBD_PRODUCT_FS_STRING        "klanghabitat quantum"
...
#define HID_INTERFACE_STRING          "AWE HID Interface"
#define USBD_SERIAL_NUMBER_STRING     "0000001B"//"0000001A"
...
uint8_t *HID_InterfaceStrDescriptor(USBD_SpeedTypeDef speed, uint16_t *length);
...
/**
  * @brief  Returns the interface string descriptor for HID.        
  * @param  speed: Current device speed
  * @param  length: Pointer to data length variable
  * @retval Pointer to descriptor buffer
  */
uint8_t *HID_InterfaceStrDescriptor(USBD_SpeedTypeDef speed, uint16_t *length)
{
    USBD_GetString((uint8_t *)HID_INTERFACE_STRING, USBD_StrDesc, length);
