...
// ST Custom modules
extern const ModClassModule awe_modSTBassManagerClass;
extern const ModClassModule awe_modSTBiquadCascadeClass;
extern const ModClassModule awe_modSTGainManagerClass;
extern const ModClassModule awe_modSTGraphicEqClass;
extern const ModClassModule awe_modSTHeadphoneVirtClass;
extern const ModClassModule awe_modSTOmni2Class;
extern const ModClassModule awe_modSTOmniSurroundClass;
extern const ModClassModule awe_modSTSmartVolumeClass;
extern const ModClassModule awe_modSTSMRClass;
extern const ModClassModule awe_modSTSoundDetectClass;
